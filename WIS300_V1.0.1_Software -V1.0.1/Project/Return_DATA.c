...
void Return_Channel_Offset(void)
{
	...
	Calibration_return.Channel=CALIBRATION_CFG.Ch_Select;
...
void Return_Channel_CFG(void)
{
	...
	ADS1248_CS(Ch_A_ID);
	if(ADS1248_ReadREG(ADS_GPIODAT)==TWO_WIRE_SINGLE_BRIDGE)   Channel_CFG.A_bridge_type=0x00;
	if(ADS1248_ReadREG(ADS_GPIODAT)==THREE_WIRE_SINGLE_BRIDGE) Channel_CFG.A_bridge_type=0x01;
	if(ADS1248_ReadREG(ADS_GPIODAT)==HALF_BRIDGE) Channel_CFG.A_bridge_type=0x02;
	if(ADS1248_ReadREG(ADS_GPIODAT)==FULL_BRIDGE) Channel_CFG.A_bridge_type=0x04;
	
	
	ADS1248_CS(Ch_B_ID);
	if(ADS1248_ReadREG(ADS_GPIODAT)==TWO_WIRE_SINGLE_BRIDGE)   Channel_CFG.B_bridge_type=0x00;
	if(ADS1248_ReadREG(ADS_GPIODAT)==THREE_WIRE_SINGLE_BRIDGE) Channel_CFG.B_bridge_type=0x01;
	if(ADS1248_ReadREG(ADS_GPIODAT)==HALF_BRIDGE) Channel_CFG.B_bridge_type=0x02;
	if(ADS1248_ReadREG(ADS_GPIODAT)==FULL_BRIDGE) Channel_CFG.B_bridge_type=0x04;
	
	
	ADS1248_CS(Ch_C_ID);
	if(ADS1248_ReadREG(ADS_GPIODAT)==TWO_WIRE_SINGLE_BRIDGE)   Channel_CFG.C_bridge_type=0x00;
	if(ADS1248_ReadREG(ADS_GPIODAT)==THREE_WIRE_SINGLE_BRIDGE) Channel_CFG.C_bridge_type=0x01;
	if(ADS1248_ReadREG(ADS_GPIODAT)==HALF_BRIDGE) Channel_CFG.C_bridge_type=0x02;
	if(ADS1248_ReadREG(ADS_GPIODAT)==FULL_BRIDGE) Channel_CFG.C_bridge_type=0x04;
	
	ADS1248_CS(Ch_D_ID);
	if(ADS1248_ReadREG(ADS_GPIODAT)==TWO_WIRE_SINGLE_BRIDGE)   Channel_CFG.D_bridge_type=0x00;
	if(ADS1248_ReadREG(ADS_GPIODAT)==THREE_WIRE_SINGLE_BRIDGE) Channel_CFG.D_bridge_type=0x01;
	if(ADS1248_ReadREG(ADS_GPIODAT)==HALF_BRIDGE) Channel_CFG.D_bridge_type=0x02;
	if(ADS1248_ReadREG(ADS_GPIODAT)==FULL_BRIDGE) Channel_CFG.D_bridge_type=0x04;
