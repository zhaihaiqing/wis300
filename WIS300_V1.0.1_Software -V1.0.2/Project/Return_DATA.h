...
void Return_ChannelA_Offset(void);	//声明返回通道校准参数函数
void Return_ChannelB_Offset(void);	//声明返回通道校准参数函数
void Return_ChannelC_Offset(void);	//声明返回通道校准参数函数
void Return_ChannelD_Offset(void);	//声明返回通道校准参数函数
